   ...
   public ControllerImpl(){
    ...
    public String addComputer(String computerType, int id, String manufacturer, String model, double price) {
        ...
        if (computerType.equals("Laptop")){
            computers.put(id, new Laptop(id, manufacturer, model,  price));
        } else if (computerType.equals("DesktopComputer")){
            computers.put(id, new DesktopComputer(id, manufacturer, model, price));
        } else {
    ...
    public String BuyBestComputer(double budget) {
        ...
        List<Computer> filteredComputers = computers.values().stream().filter(c -> c.getPrice() <= budget).sorted(Comparator.comparing(Computer::getOverallPerformance).reversed()).collect(Collectors.toList());
