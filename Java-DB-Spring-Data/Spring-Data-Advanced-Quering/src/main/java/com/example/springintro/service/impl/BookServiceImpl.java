...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<Book> findAllByEditionTypeAndCopiesIsLessThan(EditionType editionType, int copies) {
        return this.bookRepository
                .findAllByEditionTypeAndCopiesIsLessThan(editionType, copies);
    }

    @Override
    public List<Book> findAllByPriceIsLessThanOrPriceGreaterThan(BigDecimal lowest, BigDecimal highest) {
        return this.bookRepository
                .findAllByPriceIsLessThanOrPriceGreaterThan(lowest, highest);
    }

    @Override
    public List<String> booksByPriceLowerThan5AndHigherThan40() {
        return this.bookRepository
                .findAllByPriceIsLessThanOrPriceGreaterThan(new BigDecimal(5L), new BigDecimal(40L))
                .stream()
    ...
    @Override
    public List<String> findAllByEditionTypeGoldAndCopiesIsLessThan5000() {
        return this.bookRepository
    ...
    @Override
    public  List<String> findAllByReleaseDateBeforeLd(LocalDate date) {
        return this.bookRepository
    ...
    @Override
    public List<String> findAllByAuthorLastNameStartsWith(String beginning) {
        return this.bookRepository
    ...
    @Override
    public int countAllByTitleGreaterThanNumber(int length) {
        return this.bookRepository
                .countAllByTitleGreaterThanNumber(length);
    }

    @Override
    public List<String> countAllByCopiesAndAuthorOrderDesc() {
        return this.bookRepository
                .countAllByCopiesAndAuthorOrderDesc()
                .stream()
                .map(res-> String.format("%s - %s",
                        res[0], res[1]))
                .collect(Collectors.toList());
    }
